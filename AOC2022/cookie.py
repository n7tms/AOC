...
SESSION_COOKIE = '53616c7465645f5fa81b69e51cebf457a669874ce2a15e1038f8f07c7b2c764fbdd4ebf3fdba2a0351327ebe2f78f40fd0196440f065c82c90bc05836750f14d'
CURRENT_DIR = os.getcwd()
HEADERS = {"cookie": f"session={'SESSION_COOKIE'}", }

def handle_error_status(code):
    if code == 404:
        print(f"{code}: This day is not available yet!")
        quit()
    elif code == 400:
        print(f"{code}: Bad credentials!")
        quit()
    elif code > 400:
        print(f"{code}: General error!")
        quit()
...
print(request_content(2021,1,'input'))
